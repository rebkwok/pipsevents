...
var toggleWaitingList = function()  {
    ...
    var processResult = function(
      ...
      for (tab_index = 0; tab_index < location_count ; tab_index++) {
          ...
          $('#waiting_list_button_' + event_id + '_' + tab_index).html(result);
      }
   }

   $.ajax(
       {
          url: '/bookings/ajax-toggle-waiting-list/' + event_id + '/',
          dataType: 'html',
...
$(document).ready(function()  {
   ...
   */
  $('.td_ajax_waiting_list_btn').click(_.debounce(toggleWaitingList,
