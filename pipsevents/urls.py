...
urlpatterns = [
    ...
    path('membership/voucher-validate/', membership_voucher_validate, name="membership_voucher_validate"),
    ...
    path('membership/voucher/validate', membership_voucher_apply_validate, name="membership_voucher_apply_validate"),
