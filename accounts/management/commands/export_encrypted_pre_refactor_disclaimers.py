...
from .export_pre_refactor_disclaimers import export_unencrypted_disclaimers
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        exported = list(export_unencrypted_disclaimers(base_outputfile))
        for (count, outputfile) in exported:
            # read csv, join row cells with "@@@@@" and rows with "&&&&&"
